if (process.env.AI_SMOKE_MOCK === "1") {
  ...
  const mockReport = {
    ...
    chapters: [
      chapter("overview", "命盘总览", ["Z001", "Z002"]),
      chapter("career_wealth", "事业及财运", ["Z015", "Z020"]),
      chapter("relationships", "感情及婚姻", ["Z018", "Z002"]),
      chapter("health", "健康", ["Z019", "Z003"]),
      chapter("children", "子女", ["Z017", "Z002"]),
      chapter("family", "父母及兄弟", ["Z014", "Z021"]),
      chapter("timing", "运势节奏及关键节点", ["Z004", "Z030"]),
    ],
